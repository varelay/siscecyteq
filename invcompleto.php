    ...
    <tbody>
      <?php
       ...
       <tr>
         ...
         <a class="oculto" style="color: black;" href="editarInventario.php?idInventario=<?php echo $row['idInventario']; ?>">   <img src="imagenes/actualizar.png">  Actualizar </a></td>
...
<form class="" action="funcionesBD.php" method="post">
  <button type="submit" name="btnAInventario" class="btn btn-primary btn-sm & centrado" style="width: 250px; height: 40px; font-size: 1.1rem;">Agregar objeto</button>
</form>
</div>
</div>
