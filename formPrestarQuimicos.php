...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <li class="f"><a href="menu.php" style="font-family: 'Pacifico', cursive; font-size: 1.3rem;">Inicio</a></li>
      ...
      <li class="f"><a href="formPrestarQuimicos.php" style="color: yellowgreen; font-family: 'Pacifico', cursive; font-size: 1.3rem;" class="active">Prestar Material</a></li>
...
<div class="contindex">
            ...
            <h1>Prestar Material<span class="typer" id="some-id" data-delay="200" data-delim=":" data-words="..." data-colors="red"></span><span class="cursor" data-cursorDisplay="_" data-owner="some-id"></span></h1>
