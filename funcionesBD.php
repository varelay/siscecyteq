...
if (isset($_POST['btnAInventario'])) {
  echo "<script>window.location='formInvenario.php'</script>";
}
...
if  (isset($_POST['btnActualizarInventario'])){
  ...
  if (($_FILES['Imagen']['tmp_name']!='')){
    $Imagen = addslashes(file_get_contents($_FILES['Imagen']['tmp_name']));
    $query= "UPDATE tbinventariotoño SET descripcion='$descripcion', marca='$marca', modelo='$modelo', serie='$serie', costo='$costo',inventario='$inventario',observaciones='$observaciones', Imagen='$Imagen' WHERE idInventario='$idInventario' ";
    $resultado_actualizar = $conexion -> query($query);
    if($resultado_actualizar ){
      echo "<script>window.location='invcompleto.php'</script>";
    } else {
    ...
    $query= "UPDATE tbinventariotoño SET descripcion='$descripcion', marca='$marca', modelo='$modelo', serie='$serie', costo='$costo',inventario='$inventario',observaciones='$observaciones' WHERE idInventario='$idInventario'  ";
    $resultado_actualizar = $conexion -> query($query);
    if($resultado_actualizar ){
      echo "<script>window.location='invcompleto.php'</script>";
    } else {
...
if  (isset($_POST['btnAgregarInventario'])){
  ...
  if (($_FILES['Imagen']['tmp_name']!='')){
    $Imagen = addslashes(file_get_contents($_FILES['Imagen']['tmp_name']));
    $query= "INSERT INTO tbinventariotoño (descripcion, marca, modelo, serie, costo, inventario, observaciones, Imagen) VALUES ('$descripcion','$marca','$modelo','$serie','$costo','$inventario','$observaciones','$Imagen')";
    $resultado_actualizar = $conexion -> query($query);
    if($resultado_actualizar ){
      echo "<script>window.location='invcompleto.php'</script>";
    } else {
    ...
    $query= "INSERT INTO tbinventariotoño (descripcion, marca, modelo, serie, costo, inventario, observaciones) VALUES ('$descripcion','$marca','$modelo','$serie','$costo','$inventario','$observaciones')";
    $resultado_actualizar = $conexion -> query($query);
    if($resultado_actualizar ){
      echo "<script>window.location='invcompleto.php'</script>";
    } else {
